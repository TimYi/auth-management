...
public class InjectedShiroFilterFactoryBean extends ShiroFilterFactoryBean {
	...
	protected FilterChainManager createFilterChainManager() {
        ...
        accessDefinitionManager.init();
        accessDefinitionManager.refresh();
        return manager;
	}
	...
	protected void applyLoginUrlIfNecessary(Filter filter) {
	...
	protected void applySuccessUrlIfNecessary(Filter filter) {
	...
	protected void applyUnauthorizedUrlIfNecessary(Filter filter) {
