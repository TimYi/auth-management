...
public class ObjectPermissionAdapter extends 
	AbstractDtoAdapter<ObjectPermission, ObjectPermissionVo, ObjectPermissionInputArgs> {
	
	@Autowired
	private OperatePermissionRepository operatePermissionRepository;
	
	@Override
	public ObjectPermission postConvertToDo(ObjectPermissionInputArgs i,
			ObjectPermission d) {
		return postUpdate(i, d);
	}

	@Override
	public ObjectPermission postUpdate(ObjectPermissionInputArgs i,
			ObjectPermission d) {
