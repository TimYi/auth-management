...
<div id="title">添加权限</div>
<form role="form" action="/permission" class="form-horizontal ajax" method="post" redirect="/permission">
   ...
   <div class="form-group">
       ...
       <div class="col-sm-10">
	       <input type="text" class="form-control" name="permissionType" value="${type }" readonly="readonly" />
       </div>
   </div>
   <c:if test="${type eq 'OPERATE' }">
   <input type="hidden" name="fieldId" value="${parent.id }" />
   <div class="form-group">
